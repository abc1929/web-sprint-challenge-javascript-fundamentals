...
// nestedFunction() can access 'internal' because 'internal' is declared in myFunction(), which defines the parent block of nestedFunction(). You can always access variable that exists in a function's ancestor scopes(going up), but you can't access down. Also the order matters, too, but since 'internal' is defined before nestedFunction(), we are all good.
...
// You just create a cuboid with three dimension with the same length, nothing to reimplement.
